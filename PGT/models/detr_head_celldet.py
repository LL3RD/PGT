...
class DETRHead_CellDet(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is DETRHead_CellDet):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is DETRHead_CellDet:
            convert_dict = {
    ...
    def simple_test_bboxes(self, feats, img_metas, rescale=False, **kwargs):
        ...
        outs = self.forward(feats, img_metas, **kwargs)  # [cls, points]
