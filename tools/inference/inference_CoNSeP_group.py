...
def parse_args():
    ...
    parser.add_argument('--img_file',
                        default="/Path to Dataset/Test/Images/",
                        help='Image file')
    parser.add_argument('--img_file_256',
                        default="/Path to Dataset/SAHI_250_8/Test/",
                        help='Image file')
    parser.add_argument('--config',
                        default="configs/Swin_CoNSeP_PGT.py",
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default="/Path to Dataset/PGT_CoNSeP.pth",
...
def det(args, pred_centroid, pred_inst_type, img_name, img_idx):
    global pred_idx_offset, pred_inst_type_all, unpaired_pred_all, unpaired_true_all, true_idx_offset, true_inst_type_all, paired_all, num_classes
