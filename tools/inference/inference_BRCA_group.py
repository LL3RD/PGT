...
def parse_args():
    ...
    parser.add_argument('--img_file',
                        default="/Path to Dataset/BRCA/Test/Images/",
                        help='Image file')
    parser.add_argument('--img_file_256',
                        default="/Path to Dataset/BRCA/SAHI/BRCA_Test/",
                        help='Image file')
    parser.add_argument('--config',
                        default="configs/Swin_BRCA_PGT.py",
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default="/Path to Dataset/BRCA/PGT_BRCA.pth",
                        help='Checkpoint file')
    parser.add_argument('--gt-file',
                        default="/Path to Dataset/BRCA/Test/Labels/",
...
def det(args, pred_centroid, pred_inst_type, img_name, img_idx):
    ...
    sio.savemat(os.path.join("/data2/huangjunjia/coco/Visual/QuantitiveC/BRCA/GViT/", img_name + ".mat"),
                pred_mat)
