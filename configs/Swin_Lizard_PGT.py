...
dataset_type = 'CellDetDataset_Lizard'
data_root = '/Path to Dataset/Lizard_COCO_6Classes/'
ann_root = '/Path to Dataset/Lizard_COCO_6Classes/annotations/'
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=ann_root + 'Lizard_test.json',
        img_prefix=data_root + 'Lizard_Test/',
        pipeline=test_pipeline,
        data_root=ann_root_hovernet))


evaluation = dict(interval=800, metric='points', save_best='F1c_Avg', rule="greater")
