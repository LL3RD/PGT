...
data_root = "/Path to Dataset/HoverNet_CoNSeP_500x500/SAHI_250_8/"
test_root = "/Path to Dataset/HoverNet_CoNSeP_500x500/Test/"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/Train_sliced_coco.json',
        img_prefix=data_root + 'Train/',
        pipeline=train_pipeline,
        data_root=test_root),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/Val_sliced_coco.json',
        img_prefix=data_root + 'Val/',
        pipeline=test_pipeline,
        data_root=test_root),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/Test_sliced_coco.json',
...
log_level = 'INFO'
load_from = None # "/data2/huangjunjia/coco/debug_cell/iter_112000.pth"
resume_from = None
workflow = [('train', 1)]
